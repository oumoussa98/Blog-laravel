...
<div class="card" >
    <div class="card-body">           
      <h1 class="card-title">{{$postChoosen->title}}</h1>
...
<div class="container-fluid">
    ...
    <li class="float-right"><a href="{{url('/')}}">See All Posts</a></li>
    </div> </div>
         ...
         @for ($j = 0; $j < 4; $j++,$i--)
          <div class="col-md-3">
            <div class="card mb-4 shadow-sm">
              <img src="{{asset('storage/'.$posts[$i-1]->photo)}}" class="bd-placeholder-img card-img-top" 
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group ">
                    <a href="{{ url('posts/'.$posts[$i-1]->id.'/preview') }} " 
